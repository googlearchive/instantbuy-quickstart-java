...
public class JwtRequests {
   ...
   */
  public static class MaskedWalletContainer extends BaseJwt {
   ...
   */
  public static class FullWalletContainer extends BaseJwt {
   ...
   */
  public static class TransactionStatusContainer extends BaseJwt {
